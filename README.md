...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/easydiffraction-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/easydiffraction-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add easydiffraction
# for installing globally
pixi global install easydiffraction
```
...
It is possible to list all of the versions of `easydiffraction` available on your platform:
...
```
pixi search easydiffraction --channel conda-forge
```
...
* [@conda-forge/easyscience](https://github.com/orgs/conda-forge/teams/easyscience/)
